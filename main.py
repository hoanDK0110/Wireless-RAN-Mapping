...
def main():
    ...
    for f in range(num_frame):
        ...
        for t in range(time_slot):
            ...
            # Tối ưu Short-term
            short_pi_sk, short_z_ib_sk, short_p_ib_sk, short_mu_ib_sk = solving.short_term(num_slices, num_UEs, num_RUs, num_RBs, rb_bandwidth, P_i, gain, R_min, arr_pi_sk, arr_phi_i_sk, epsilon)
