...
# Show result
benchmark.print_results(pi_sk, z_bi_sk, phi_i_sk, phi_j_sk, phi_m_sk, P_bi_sk, mu_bi_sk)
benchmark.print_short_term_results(R_sk_short_term)